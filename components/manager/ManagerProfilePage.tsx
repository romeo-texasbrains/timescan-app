...
export default function ManagerProfilePage({ id }: ManagerProfilePageProps) {
    ...
    async function loadData() {
      ...
      try {
        ...
        if (!managerDepartmentId) {
          setError('You are not assigned to any department as a manager.');
          setLoading(false);
          return;
        }
        ...
        if (profileError || !profileData) {
          setError('Error loading profile. The user may not exist, may not be in your department, or you don\'t have permission to view it.');
        } else {
